// app/dashboard/storage/action.ts
'use server';
...
export async function createStorageWorkOrder(formData: FormData) {
...
  try {
    ...
    const detailsPayload = {
      storage_no: formData.get('storage_no'),
      jenis_maintenance: formData.getAll('jenis_maintenance'), // Ambil semua nilai checkbox
