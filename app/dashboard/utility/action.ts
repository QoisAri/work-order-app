// app/dashboard/utility/action.ts
'use server';
...
export async function createUtilityWorkOrder(formData: FormData) {
...
  try {
    ...
    const detailsPayload = {
      lokasi_utility: formData.get('lokasi_utility'),
      jenis_utility: formData.get('jenis_utility'), // Radio button lebih sederhana
