...
export default function MrsForm({ equipmentId }: { equipmentId: string }) {
  ...
  const nomorMrsOptions = ["MRS-01", "MRS-02", "MRS-03"]; // Contoh, idealnya dari database
    ...
    <div className="w-full max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <select name="nomor_mrs" id="nomor_mrs" required className="mt-2 block w-full rounded-md border-gray-300 shadow-sm">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <input type="text" name="lokasi_mrs" id="lokasi_mrs" required className="mt-2 block w-full rounded-md border-gray-300 shadow-sm" />
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <textarea name="deskripsi_maintenance" id="deskripsi_maintenance" rows={4} required className="mt-2 block w-full rounded-md border-gray-300 shadow-sm"></textarea>
        </div>
