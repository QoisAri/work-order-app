// app/dashboard/safety-equipment/action.ts
'use server';
...
export async function createSafetyEquipmentWorkOrder(formData: FormData) {
...
  try {
    ...
    const detailsPayload = {
      lokasi_equipment: formData.get('lokasi_equipment'),
      jenis_equipment: formData.get('jenis_equipment'), // Radio button lebih sederhana
      deskripsi_pekerjaan: formData.get('deskripsi_pekerjaan'),
