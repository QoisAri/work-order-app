// app/dashboard/survey/action.ts
'use server';
...
export async function createSurveyWorkOrder(formData: FormData) {
...
  try {
    ...
    const detailsPayload = {
      lokasi_survey: formData.get('lokasi_survey'),
      deskripsi_survey: formData.get('deskripsi_survey'),
